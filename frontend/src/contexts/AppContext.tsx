...
const translations = {
  pt: {
    ...
    'certificates.validate.description': 'Digite o ID do Certificado ou escaneie o código QR para verificar sua autenticidade.',
  ...
  en: {
    ...
    'certificates.validate.description': 'Enter the Certificate ID or scan the QR code to verify its authenticity.',
